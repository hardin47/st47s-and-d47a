...
Computational Statistics was last taught in Fall 2024, and materials can be found on the <a href = "https://m154-comp-stats.netlify.app/" target = "_blank">course website</a> where you will find:
...
We will also use the Canvas course management system.  Canvas will be used for materials which are not publicly available.  This includes:
