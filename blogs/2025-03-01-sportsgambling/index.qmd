...
The UC system doubled down on the calculus pathway, despite mathematician David Bressoud (DeWitt Wallace Professor Emeritus, Macalester College) <a href = "https://www.mathvalues.org/masterblog/launchings20201001" target = "_blank">explaining</a> how broken the calculus pathway really is. Bressoud recognizes that the "singular focus on calculus sucks the oxygen out of" building a strong curriculum for statistics and data science.  He argues that a "truly co-equal path that develops computational and data skills" is needed [@bressoud2020].
