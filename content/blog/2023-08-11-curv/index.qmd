...
From there it didn't immediately show up on the website.  I tried a bunch of different things. Maybe it helped that I moved back and forth from the gh-pages branch (because I was updatign senior theses)???

to get the md file from this .qmd file:

quarto render index.qmd --to markdown

https://stackoverflow.com/questions/76801903/how-to-keep-the-markdown-header-when-rendering-from-qmd-to-md-in-quarto
```
...
```{r}
#| echo: FALSE
#| fig-alt: A set of four coasters including Gosset, Pearson, Bayes, and Fisher
...
```{r}
#| echo: FALSE
#| fig-alt: In a Google search for famous statisticians, the individuals listed include Tukey, Nightingale, Fisher, Cox, Pearson, Box, Bayes, Deming, and Gosset.
