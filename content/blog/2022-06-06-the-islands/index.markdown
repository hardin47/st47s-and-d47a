...
# Notice that the observed difference in means is:
xbar1 - xbar2
```
...
```r
# Notice that the estimated variability for the difference in sample means is:
...
RStudio has <a href = "https://www.rstudio.com/blog/real-time-collaborative-editing-on-rstudio-cloud/" target = "_blank">just recently described</a> products that allow groups to work simultaneously on a single document.
