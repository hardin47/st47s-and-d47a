...
for Pomona-Pitzer Baseball</a>, a <a href = "" target = "_blank">project</a> to create an automated Extract-Transform-Load (ETL) pipline that connects the Pomona-Pitzer baseball TrackMan system directly to a SQL database.</li>
<li></li>
<li></li>
<li></li>
</ul>
